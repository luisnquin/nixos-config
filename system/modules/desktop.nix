...
# exec --no-startup-id nitrogen --set-auto ~/Projects/github.com/luisnquin/walls/desktop/anime/anime-girl-hand-in-hair.png
# exec_always --no-startup-id numlockx off
# # Use pactl to adjust volume in PulseAudio.
# set $refresh_i3stat;nuus killall -SIGUSR1 i3status
...
# bindsym $mod+q exec rofi -modi drun -show drun
